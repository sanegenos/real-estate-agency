...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feature: Schema.Attribute.Relation<'oneToMany', 'api::property.property'>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    postpublishedAt: Schema.Attribute.DateTime &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    distanceToBeach: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    features: Schema.Attribute.Relation<'manyToOne', 'api::feature.feature'>;
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'New Project'>;
    ...
    type: Schema.Attribute.Enumeration<
      ['villa', 'apartment', 'house', 'penthouse', 'townhouse', 'land']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
