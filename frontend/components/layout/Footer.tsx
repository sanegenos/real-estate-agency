    ...
    <footer className="bg-gray-50 border-t mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Info Links */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-4 text-center">INFO</h3>
          ...
          <div className='flex flex-col items-center md:items-start'>
            <h3 className="font-semibold text-gray-900 mb-4 text-center">CONTACT US</h3>
            <ul className="space-y-2">
              ...
              <li className="flex items-start text-gray-600">
                ...
                Kemeragzi Mah. Aksu, Antalya, Turkey
              </li>
              <li className="flex items-center text-gray-600">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                info@silpagargrup.com
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-gray-600">
          © Silpagar Grup - Tüm hakları saklıdır.
        </div>
      </div>
